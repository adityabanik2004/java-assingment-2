...
class MobileShopSystem {
    ...
    public static void initializeAndPurchase() {
        ...
        vivoMobile.setModel("V23");
        vivoMobile.setAndroidVersion("Android 15");

        Mobile samsungMobile = new Mobile();
        samsungMobile.setBrand("pixel");
        samsungMobile.setModel("pixel 8");
        ...
        Mobile[] mobiles = {vivoMobile, pixelMobile, iphoneMobile};
        ...
        customer.setAddress("Salkia,Howrah");
